...
public class AnvilWebLifecycleListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        LOG.info("Application started: [{}]", event.getApplicationContext().getApplicationName());
        registerMBean();
    }
    ...
    public void handleContextStoppedEvent(ContextStoppedEvent event) {
        LOG.info("Application stopped: [{}]", event.getApplicationContext().getApplicationName());
        unregisterMBean();
    }
